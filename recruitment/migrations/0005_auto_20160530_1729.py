...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('recruitment', '0004_auto_20160530_1729'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('ID', models.CharField(max_length=11, serialize=False, primary_key=True)),
                ('company_id', models.ForeignKey(to='recruitment.Company')),
            ],
        ),
        migrations.CreateModel(
            name='CV',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('ID', models.CharField(max_length=11, serialize=False, primary_key=True)),
                ('cv_id', models.ForeignKey(to='recruitment.CV')),
                ('user_id', models.ForeignKey(to='recruitment.User')),
            ],
        ),
        migrations.AddField(
            model_name='cv',
